...
use Tests\Fixtures\Tooling\EloquentStateMachines\DuplicateTransitionTrigger;
use Tests\TestCase;
...
class StateMachineTest extends TestCase
{
    ...
    public function it_is_makeable(): void
    {
        $this->assertInstanceOf(
            StateMachine::class,
            StateMachine::make(User::factory()->make(), Status::Registered)
        );
    }
    ...
    {
        $stateMachine = StateMachine::make(User::factory()->make(), Status::Activated);
    ...
    public function it_throws_exception_when_case_has_duplicate_trigger(): void
    {
        ...
        $stateMachine = StateMachine::make(User::factory()->make(), DuplicateTransitionTrigger::Active);
